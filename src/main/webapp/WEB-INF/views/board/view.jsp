...
<body>
	<div class="container">
		...
		<table class="table">
			...
			<tr>
				<td><span class="writer">${vo.b_id }</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<span class="hit">조회 ${vo.b_view }</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<span class="write_date"><fmt:formatDate
							value="${vo.b_date }" pattern="yyyy.MM.dd" /></span></td>
			</tr>
	...
	<form action="delete.do" method="post" id="deleteForm">
		<input type="hidden" name="b_no" value="${vo.b_no}" /> <input
			type="hidden" name="b_id" value="${vo.b_id}" id="deleteID" /> <input
